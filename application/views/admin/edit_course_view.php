     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/content/course_saveedit/<?php echo $info->id;?>" method="post">
                   <fieldset>
                     
             
                     <!-- Name input-->
                     <div class="form-group">
                      <label class="col-md-2 control-label" for="name">项目名</label>
                      <div class="col-md-10">
                        <input id="name" name="name" type="text" value="<?php echo $info->name;?>" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="col-md-2 control-label" for="type">课程分类</label>
                      <div class="col-md-10">
                        <select id="type" name="type" class="form-control">
                        <?php foreach($type as $tp): ?>
                          <option value="<?php echo $tp->id;?>" <?php if($info->type == $tp->id){ echo 'selected="selected"';}?>><?php echo $tp->type;?></option>
                        <?php endforeach ?>
                        </select>
                      </div>
                    </div>
                     ...
                     <!-- Message body -->
                     <div class="form-group" >
                      <label class="col-md-2 control-label" for="message">课程内容</label>
                       <div class="col-md-10">
