        ...
        <div class="col-md-11" style="margin-top:20px;">
          <?php if($flag){ ?>
                 <div class="alert alert-success">
                     <strong> 发布成功!</strong> 你可继续 <a href="<?php echo base_url(); ?>admin/content/add_activity" class="alert-link">发布</a>或者<a href="#" class="alert-link">管理优惠活动</a>.
                 </div>
               <?php }else{ ?>
                 <div class="alert alert-danger">
                     <strong>发布失败!</strong> 尝试<a href="<?php echo base_url(); ?>admin/content/add_activity" class="alert-link">重新发布</a> .
                 </div>
               <?php } ?>
        </div>
        </div>
