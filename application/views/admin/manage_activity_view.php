     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
                ...
                <div class="col-md-12">
                <h4>优惠活动信息 <a href="<?php echo base_url(); ?>admin/content/add_activity" class="btn btn-primary pull-right">新建优惠活动</a></h4>
            ...
            <tbody>
            <?php foreach($infos['activitys'] as $key=>$sl): ?>
            <tr id="<?php echo $sl->id;?>">
            <td><?php echo $sl->title;?></td>
            <td><?php echo $sl->updatetime;?></td>
            <td><?php echo $sl->sname;?></td>
            <td><p><a class="btn btn-primary btn-xs btnedit" href="<?php echo base_url(); ?>admin/content/edit_activity/<?php echo $sl->id;?>"><i class="fa fa-pencil-square-o"></i></a></p></td>
        ...
        <div class="clearfix"></div>
          <ul class="pager">
           <?php if($infos['link']['pageNo']>1){ ?>
             <li class="previous"><a href="<?php echo base_url(); ?>admin/content/activity/<?php echo $infos['link']['pageNo']-1;?>">&larr; 上一页</a></li>
           <?php } ?>
           <?php if($infos['link']['pageNo']<$infos['link']['totalPageNum']){ ?>
             <li class="next"><a href="<?php echo base_url(); ?>admin/content/activity/<?php echo $infos['link']['pageNo']+1;?>">下一页 &rarr;</a></li>
           <?php } ?>
           </ul>
    ...
    <!-- Page Specific Plugins -->
     <script type="text/javascript">
      ...
      $("body").on("click","#suredel",function(){
        act = $(this).attr("actname");
         url = "<?php echo base_url(); ?>admin/content/del_activity/"+act;
        //alert(url);
        if(url!=""){
            window.location = url;
        }
