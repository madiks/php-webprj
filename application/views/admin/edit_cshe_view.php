     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/course/cshe_saveedit/<?php echo $info->id;?>" method="post">
                   <fieldset>
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-10">
                         <input id="cname" name="cname" type="text" value="<?php echo $info->cname;?>" class="form-control">
                       </div>
                     </div>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-md-10">
                         <input id="coach" name="coach" type="text" value="<?php echo $info->coach;?>" class="form-control">
                       </div>
                     </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <select id="sname" name="shopname" class="form-control">
                          ...
                          <option value="<?php echo $sl->shopname;?>" <?php if($info->shopname == $sl->shopname){ echo 'selected="selected"';}?>><?php echo $sl->shopname;?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-10">
                         <input id="time" name="time" type="text" value="<?php echo $info->time;?>" class="form-control">
                       </div>
                     </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="col-md-10">
                         <input id="time_start" name="time_start" type="text" value="<?php echo $info->time_start;?>" class="form-control">
                       </div>
                     </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="col-md-10">
                         <input id="time_end" name="time_end" type="text" value="<?php echo $info->time_end;?>" class="form-control">
                       </div>
                     </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="col-md-10">
                         <input id="limit" name="limit" type="text" value="<?php echo $info->limit;?>" class="form-control">
                       </div>
                     </div>
                      ...
                      <div class="col-md-10">
                        <select id="status" name="status" class="form-control">
                         <option value="1" <?php if($info->status == 1){ echo 'selected="selected"';}?>>可选课</option>
                         <option value="0" <?php if($info->status == 0){ echo 'selected="selected"';}?>>不可选课</option>
                        </select>
                      </div>
                    </div>
