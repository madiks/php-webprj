          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse navbar-ex1-collapse" style="height: 1px;">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<?php echo base_url(); ?>courses/">健身课程</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <?php foreach($course_nav as $key=>$navlist): ?>
                <?php if($navid == $navlist->id){ ?>      
                          <div class="panel panel-default">
                              <div class="panel-heading">
                                  <h4 class="panel-title">
                                      <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $key;?>"><?php echo $navlist->type;?></a>
                                  </h4>
                              </div>
                              <div id="collapse<?php echo $key;?>" class="panel-collapse collapse in">
                                  <div class="panel-body">
                                      <table class="table">
                                      <?php foreach($navlist->courselist as $keyi=>$val): ?>
                                          <tr>
                                              <td>
                                                <a href="<?php echo base_url(); ?>courses/details/<?php echo $val->id;?>"><?php echo $val->name;?></a>
                                              </td>
                                          </tr>
                                      <?php endforeach ?>   
                                      </table>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $key;?>" class="collapsed"><?php echo $navlist->type;?></a>
                        </h4>
                    </div>
