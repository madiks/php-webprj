     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/content/fitness_save" method="post">
                   <fieldset>
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-11">
                         <input id="title" name="title" type="text" placeholder="文章标题" class="form-control">
                       </div>
                     </div>
