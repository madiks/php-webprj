  ...
  <body>
          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse navbar-ex1-collapse" style="height: 1px;">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<?php echo base_url(); ?>activity/">优惠活动</a></li>
                <li class="dropdown">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="container">
         <div class="jumbotron">
           <h1><?php echo $showitem->title;?></h1>
           <p><?php echo $showitem->desc;?></p>
           <p><a class="btn btn-primary btn-lg" role="button" href="<?php echo base_url(); ?>activity/detail/<?php echo $showitem->id;?>">了解详细</a></p>
         </div>
         <table class="table table-hover">
           <thead>
            ...
            <tbody>
            <?php foreach($infos['activitys'] as $key=>$val): ?>
                <tr>
                    <td>
                      <a href="<?php echo base_url(); ?>activity/detail/<?php echo $val->id;?>"><?php echo $val->title;?></a>
                    </td>
                    <td>
                      <?php echo $val->sname;?>
                    </td>
        ...
        <?php if($infos['link']['pageNo']>1){ ?>
          <li class="previous"><a href="<?php echo base_url(); ?>activity/index/<?php echo $infos['link']['pageNo']-1;?>">&larr; 上一页</a></li>
        <?php } ?>
        <?php if($infos['link']['pageNo']<$infos['link']['totalPageNum']){ ?>
          <li class="next"><a href="<?php echo base_url(); ?>activity/index/<?php echo $infos['link']['pageNo']+1;?>">下一页 &rarr;</a></li>
        <?php } ?>
        </ul>
        </div>
      </div>
