     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-8 col-md-offset-2 well" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/indexmod/save_desc" method="post" enctype="multipart/form-data">
                   <fieldset>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="subtitle" name="subtitle" type="text" placeholder="介绍副标题" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <!-- Message body -->
                     <div class="form-group" >
                      <label class="col-md-2 control-label" for="message">介绍图片</label>
                       <div class="col-md-10">
