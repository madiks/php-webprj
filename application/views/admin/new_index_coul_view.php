     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-8 col-md-offset-2 well" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/indexmod/save_coul" method="post" enctype="multipart/form-data">
                   <fieldset>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="link" name="link" type="text" placeholder="轮播链接" class="form-control">
                      </div>
                    </div>
                               
                     <!-- Message body -->
                     <div class="form-group" >
                      <label class="col-md-2 control-label" for="message">轮播图片</label>
                       <div class="col-md-10">
