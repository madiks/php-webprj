...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title><?php echo $fitness->title;?>|长春环宇健身中心</title>
      ...
      <div class="row">
        ...
        <h7 class="featurette-heading" style="margin-top:20px">健身常识 <span class="text-muted">Learn About Fitness</span></h7>
         <div class="row">
            ...
            <div class="col-md-10">
              <h3 class="text-center"><b><?php echo $fitness->title;?></b></h3>
              <p class="text-right">发布时间:<?php echo $fitness->updatetime;?></p>
              <div><?php echo $fitness->content;?></div>
            </div>
            <div class = "col-md-1"></div>
