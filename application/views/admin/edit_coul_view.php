     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-8 col-md-offset-2 well" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/indexmod/editsave_coul/<?php echo $coul->id;?>" method="post" enctype="multipart/form-data">
                   <fieldset>
                     
                    
                     <!-- Name input-->
                     <div class="form-group">
                       <label class="col-md-2 control-label" for="title">轮播标题</label>
                       <div class="col-md-10">
                         <input id="title" name="title" type="text" value="<?php echo $coul->title;?>" class="form-control">
                       </div>
                     </div>

                    <div class="form-group">
                      <label class="col-md-2 control-label" for="desc">轮播描述</label>
                      <div class="col-md-10">
                       <textarea class="form-control" id="desc" name="desc"  rows="3"><?php echo $coul->desc;?></textarea>
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-md-2 control-label" for="status">轮播状态</label>
                      <div class="col-md-10">
                        <select id="status" name="status" class="form-control">
                          <option value="1" <?php if($coul->status == 1){ echo 'selected="selected"';}?>>可用</option>
                          <option value="2" <?php if($coul->status == 2){ echo 'selected="selected"';}?>>不可用</option>
                        </select>
                      </div>
                    </div>

                     <div class="form-group">
                      <label class="col-md-2 control-label" for="link">轮播链接</label>
                      <div class="col-md-10">
                        <input id="link" name="link" type="text" value="<?php echo $coul->link;?>" class="form-control">
                      </div>
                    </div>
                     ...
                     <div class="form-group" >
                      <label class="col-md-2 control-label" for="message">原轮播图片</label>
                       <div class="col-md-10">
                       <img src="<?php echo base_url(); ?><?php echo $coul->img;?>" alt="" class="img-thumbnail">
                       </div>
                     </div>

                     <div class="form-group" >
                      <label class="col-md-2 control-label" for="img">轮播图片</label>
                       <div class="col-md-10">
