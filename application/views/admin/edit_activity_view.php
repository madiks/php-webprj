    ...
    <div id="wrapper">
     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>管理优惠活动 <small>修改优惠活动</small></h1>
            <ol class="breadcrumb">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/content/activity_saveedit/<?php echo $act->id;?>" method="post">
                   <fieldset>
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-10">
                         <input id="title" name="title" type="text" value="<?php echo $act->title;?>" class="form-control">
                       </div>
                     </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="desc" name="desc" type="text" value="<?php echo $act->desc;?>" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <select id="sname" name="sname" class="form-control">
                          ...
                          <option value="<?php echo $sl->shopname;?>" <?php if($act->sname == $sl->shopname){ echo 'selected="selected"'; } ?>><?php echo $sl->shopname;?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                    </div>
