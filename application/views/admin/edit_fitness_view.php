     ...
     <!-- Sidebar -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
             ...
             <li class="active"> <a href="<?php echo base_url(); ?>admin/content/add_fitness"><i class="fa fa-leaf"></i> 健身常识</a></li>
          </ul>
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/content/fitness_saveedit/<?php echo $fit->id;?>" method="post">
                   <fieldset>
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-11">
                         <input id="title" name="title" type="text" value="<?php echo $fit->title;?>" class="form-control">
                       </div>
                     </div>
                     ...
                     <!-- Message body -->
                     <div class="form-group" >
                      <label class="col-md-1 control-label" for="message">内容</label>
                       <div class="col-md-11">
                         <script id="containerss" name="content" type="text/plain">
                           <?php echo $fit->content;?>
                         </script>
                       </div>
                     </div>
