    ...
    <div id="wrapper">
     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>关于项目管理 <small>会员服务管理</small></h1>
            <ol class="breadcrumb">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/content/service_save/<?php echo $info->id;?>" method="post">
                   <fieldset>
