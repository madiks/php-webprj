    ...
    <div id="wrapper">
     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>关于项目管理 <small>添加关于项目</small></h1>
            <ol class="breadcrumb">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/content/about_save/<?php echo $info->id;?>" method="post">
                   <fieldset>
                     
             
                     <!-- Name input-->
                     <div class="form-group">
                       <label class="col-md-2 control-label" for="itemname">项目名</label>
                       <div class="col-md-10">
                         <input id="itemname" name="itemname" type="text" value="<?php echo $info->itemname;?>" class="form-control">
                       </div>
                     </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="title" name="title" type="text" value="<?php echo $info->title;?>" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="subtitle" name="subtitle" type="text" value="<?php echo $info->subtitle;?>" class="form-control">
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-md-2 control-label" for="keyword">关键字</label>
                      <div class="col-md-10">
                        <input id="keyword" name="keyword" type="text" value="<?php echo $info->keyword;?>" class="form-control">
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-md-2 control-label" for="status">模块状态</label>
                      <div class="col-md-10">
                        <select id="status" name="status" class="form-control">
                          <option value="1" <?php if($info->status == 1){ echo 'selected="selected"';}?>>启用</option>
                          <option value="0" <?php if($info->status == 0){ echo 'selected="selected"';}?>>停用</option>
                        </select>
                      </div>
                    </div>
