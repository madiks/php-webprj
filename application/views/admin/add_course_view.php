     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/content/course_save" method="post">
                   <fieldset>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="name" name="name" type="text" placeholder="项目名称" class="form-control">
                      </div>
                    </div>
