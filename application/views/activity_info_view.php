...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title><?php echo $act->title;?>|长春环宇健身中心</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row" >
        ...
        <div class="col-md-10">
          <h3 class="text-center"><b><?php echo $act->title;?></b></h3>
          <p class="text-right">发布时间:<?php echo $act->updatetime;?></p>
          <div><?php echo $act->content;?></div>
        </div>
        <div class = "col-md-1"></div>
      </div>
