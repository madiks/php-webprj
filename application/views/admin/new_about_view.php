     ...
     <!-- Sidebar -->
      ...
      <div id="page-wrapper">
        ...
        <div class="col-md-11" style="margin-top:20px;">
          <form class="form-horizontal" action="<?php echo base_url(); ?>admin/content/about_save" method="post">
                   <fieldset>
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-10">
                         <input id="itemname" name="itemname" type="text" placeholder="关于项目名" class="form-control">
                       </div>
                     </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="subtitle" name="subtitle" type="text" placeholder="副标题" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="keyword" name="keyword" type="text" placeholder="项目关键字必须唯一，不可重复" class="form-control">
                      </div>
                    </div>
